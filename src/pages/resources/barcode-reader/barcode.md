...
Note that we'll cover how to do debug an App Builder app in another codelab.
...
`aio app deploy` would have deployed the UI to a CDN but since we don't have any UI, that step is simply ignored. We'll have a separate codelab to guide you through building an App Builder App with UI.
