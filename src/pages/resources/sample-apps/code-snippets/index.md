...
(which is by default if you use Postman or browser's developer tools). More info [here](https://developer.adobe.com/runtime/docs/guides/using/throughput_tuning/#caching-responses). 
