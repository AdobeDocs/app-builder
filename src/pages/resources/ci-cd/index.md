...
Adobe Developer App Builder allows you to manage multiple environments called workspaces. Each workspace has its own setup: 
...
We recommend to go through the [App Builder CI/CD documentation](../../guides/deployment/ci_cd_for_app_builder_apps.md) to learn more about the architectural details.
