...
2. Add extension configuration 
   ...
   4. Shift contents of `src/dx-excshell-1/ext.config.yaml` left one tab space 
...
8. Done, your application should now be in the App Builder Catalog in Adobe Experience Cloud
