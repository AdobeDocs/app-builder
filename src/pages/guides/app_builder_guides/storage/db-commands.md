...
Indexing frequently queried fields is fundamental to optimizing the performance of a database. No documents may have values for the indexed fields that exceed 2048 bytes combined.
