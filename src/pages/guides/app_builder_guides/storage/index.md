...
| How many Database requests can you make per five minutes in a single App Builder workspace? | Workspace limit (fixed per workspace) | 70,000 requests/5min | No | |
