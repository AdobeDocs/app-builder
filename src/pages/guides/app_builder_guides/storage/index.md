...
| How much data can you store in the Database Service?                                    | Quota (increases with number of packs) | Up to 40 GB per App Builder pack                                                  | Yes, by purchasing more packs of App Builder                                                                                                                                                                                 |                                                                                |
| How much Database bandwidth can you utilize?                                            | Quota (increases with number of packs) | Up to 10 TB per App Builder pack                                                  | Yes, by purchasing more packs of App Builder                                                                                                                                                                                 |                                                                                |
