...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Setup              | Workspaces default to storing logs in Runtime. Included in App Builder SKU.                                                                                                                  | Log Forwarding must be configured per workspace of an App Builder application. Requires a separate log management solution.                                                                                                                            |
| When to use        | A good option for local development, or when Developer work in separate workspaces.                                                                                                          | Ideal for shared environments such as `Stage` and `Production` workspaces.                                                                                                                                                                             |
| Access to all logs | Stores application logs only for failed or asynchronous activations.                                                                                                                         | Allows access to all application logs.                                                                                                                                                                                                                 |
| Retrieving logs    | The AIO CLI can be used to fetch logs.                                                                                                                                                       | Logs must be retrieved logs from the separate log management solution.                                                                                                                                                                                 |
| Logging limits     | Maximum 10 MB of log lines per activation, beyond which log lines are truncated.                                                                                                             | <mark>Adobe I/O Runtime allows up to a maximum of 10 MB of log lines per activation beyond which log lines are truncated.</mark>                                                                                                                       |
...
| Log retention      | Logs are retained for 7 days.                                                                                                                                                                | Forwarded logs may be retained for any duration you specify.                                                                                                                                                                                           |
