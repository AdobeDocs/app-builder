...
1. Containers are kept warm after for 2 minutes after an invocation finishes. For those 2 minutes, it is highly unlikely (p&lt;.01) that invoking the same action will require a cold start.
