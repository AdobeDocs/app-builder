...
The documentation includes guides, references, and tools to help Developers understand App Builder, learn how to use it, resolve technical issues, optimize performance, and contribute to its development.
...
- **Explore** 
  ...
  - How the App Builder platform aligns to the development cycle in [How App Builder Works](../get_started/app_builder_get_started/app-builder-intro.md#overview)
